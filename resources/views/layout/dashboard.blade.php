...
<body>
    ...
    <nav>
        ...
        <div class="nav-auth">
            ...
            <a href="{{ route('signup') }}" class="nav-signup-btn">Sign up free</a>
        </div>
    </nav>
    ...
    <section class="hero">
        <div class="hero-left">
            ...
            <div class="platform-badges">
                ...
                <span>🎬 Shorts</span>
                <span>𝕏 X</span>
                <span class="coming">+ More Soon</span>
            ...
            <div class="hero-right" id="about">
                <div class="input-card">
                    ...
                    <div class="type-toggle">
                        <button class="type-btn active" onclick="setType(this, 'image')">🖼 Image</button>
                        <button class="type-btn" onclick="setType(this, 'video')">🎬 Video</button>
                        <button class="type-btn" onclick="setType(this, 'both')">📎 Both</button>
                    </div>
        ...
        <div class="limit-nudge" id="limitNudge" style="display:none;">
            ...
            <span>Enjoying the results? <strong>Create a free account</strong> and unlock 2 extra analyses.</span>
            <a href="{{ route('signup') }}" class="nudge-cta">Get 2 more →</a>
    ...
    <script>
        ...
        form.addEventListener('submit', async function(e) {
            ...
            if (analysisCount >= 3) {
                ...
                // Show signup popup
                document.getElementById('limitNudge').style.display = 'flex';
